...
export const US_STOCK_SEARCH_CATALOG: UsStockCatalogEntry[] = [
  ...
  { symbol: "AEVA", name: "Aeva Technologies Inc.", type: "Common Stock", aliases: ["aeva"] },
  { symbol: "AVAV", name: "AeroVironment Inc.", type: "Common Stock", aliases: ["aerovironment", "aero"] },
  { symbol: "ONDS", name: "Ondas Holdings Inc.", type: "Common Stock", aliases: ["ondas", "ondas holdings"] },
