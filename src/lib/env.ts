...
export const publicEnv = {
  ...
  supabaseUrl: trim(import.meta.env.VITE_SUPABASE_URL) || trim(import.meta.env.SUPABASE_URL),
  supabaseAnonKey: trim(import.meta.env.VITE_SUPABASE_ANON_KEY) || trim(import.meta.env.SUPABASE_ANON_KEY),
